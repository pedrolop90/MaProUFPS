    ...
    <table class="ufps-table ufps-table-inserted ufps-text-center">
        <thead>
            <tr>
                ...
                <th data-field="p4">P4</th>
                <th data-field="p5">P5</th>
                <th data-field="p6">P6</th>
                <th data-field="p7">P7</th>
                <th data-field="p8">P8</th>
                <th data-field="p9">P9</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                <td>3</td>
                <td>nos toca soportar a uribe</td>
                <td>8</td>
                <td>1600</td>
                <td>1/30</td>
                <td>1/60</td>
            ...
            <tr>
                <td>7</td>
                <td>road to ingenieria de software</td>
                <td>8</td>
                <td>1600</td>
                <td>1/30</td>
                <td>1/60</td>
